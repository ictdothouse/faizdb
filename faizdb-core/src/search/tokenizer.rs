...
static STOP_WORDS: LazyLock<HashSet<&'static str>> = LazyLock::new(|| {
    let words = [
        ...
        // Malay
        "ada", "adalah", "akan", "antara", "atau", "bagi", "bahkan", "bahawa", "banyak",
        "bila", "boleh", "dalam", "dan", "dapat", "dari", "daripada", "dengan", "di",
        "dia", "ia", "ini", "itu", "jika", "juga", "kami", "kamu", "ke", "kerana",
        "kita", "lagi", "lalu", "mana", "mereka", "oleh", "pada", "para", "saja",
        "sama", "sangat", "saya", "sebagai", "sedang", "seperti", "sudah", "supaya",
        "tak", "telah", "tentang", "tidak", "untuk", "yang",
    ];
...
pub fn tokenize(text: &str) -> Vec<String> {
    text.split(|c: char| !c.is_alphanumeric())
        ...
        .filter(|token| {
            token.len() > 1 && !STOP_WORDS.contains(token.as_str())
        })
        .collect()
}
