...
fn test_insert_and_nearest_neighbour() {
    ...
    index.insert("v1".to_string(), vec![1.0, 0.0, 0.0, 0.0]);
    index.insert("v2".to_string(), vec![0.0, 1.0, 0.0, 0.0]);
    index.insert("v3".to_string(), vec![0.0, 0.0, 1.0, 0.0]);
    index.insert("v4".to_string(), vec![0.0, 0.0, 0.0, 1.0]);
    index.insert("v5".to_string(), vec![0.9, 0.1, 0.0, 0.0]); // Most similar to v1
...
fn test_euclidean_distance_search() {
    ...
    index.insert("origin".to_string(), vec![0.0, 0.0, 0.0]);
    index.insert("near".to_string(), vec![0.1, 0.1, 0.1]);
    index.insert("far".to_string(), vec![10.0, 10.0, 10.0]);
